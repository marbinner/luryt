# The Optimized Conlang – Full Foundational Spec (with Voice & Subordination)

This document contains everything needed to **use** the language: phonology, morphology, semantic matrix, lexicon, syntax, derivation, and semantic typing.
...
2. **Two word classes**
   ...
   * **Atomic words**
     ...
     * Pronouns, conjunctions, prepositions, auxiliaries, digits, wh-words, quantifiers.
...
1. **Atomic words**
   ...
   * Closed classes: pronouns, particles, prepositions, auxiliaries, digits, wh-words, quantifiers, complementizers.
...
| Suffix | PoS | Function                       | Example             |
| :----- | :-- | :----------------------------- |
| -M     | N   | Noun (entity)                  | *Garam* – land      |
| -S     | ADJ | Adjective (quality)            | *Garas* – earthy    |
| -N     | V   | Verb (finite)                  | *Garan* – (to) land |
| -L     | ADV | Adverb (manner/location)       | *Garal* – on land   |
| -R     | GEN | Genitive (“of X”)              | *Garar* – of land   |
| -T     | DET | Specific instance / determiner | *Garat* – that land |
...
#### 7.3.1 Quantifier Interaction

Quantifiers and K-series prefixes both express quantity and grouping.

General conventions:

* **Quantifier words** (*kafa, kefe, nefa, nyfa*) typically **precede** the NP:

  * *Kefe koporam* — “all people / everyone (as people)”
...
* *Kefe koporam* — discourse-wide quantification “everyone (as a set of people)”
* *Kaporam* — lexically group-marked “the whole group of people in question”

Exact scope and interpretation can be left to pragmatics, but the **position** is fixed: quantifiers before the NP, K-prefixes on the head.
...
> **Nu tu ne gyfun gyfut, tu rivitus ne.**
> (more explicit:)
> **Nu tu negyfun gyfut, tu rivitus ne.**
> “If you do not eat the food, you will not be healthy.”

Where *rivitus ne* can be analysed as *Ri-vitu-s* FUT-healthy-ADJ with negation; the exact strategy for adjectival negation can be via **Ne-** prefix or a separate particle.
...
HeadKind ∈ {
  ...
  Operator,   // particles, auxiliaries
  Pronoun,
  Number,
  Unknown
}
...
You can also imagine a separate **VoiceFeature** extracted from the D-series, but that’s orthogonal to HeadKind.
...
* **Particles & auxiliaries** (`jo, ju, ja, je, ba, va, vi, la, le, li, lo`): `Operator`/`Complementizer`.
* **Digits** (`pa, pe, ...`): `Number`.
...
* *ne* — (negation, via Logic or particle; exact strategy can be refined)
